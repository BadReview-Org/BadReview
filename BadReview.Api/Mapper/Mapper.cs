...
public static class Mapper
{
    ...
    public static DetailGameDto CreateDetailGameDto(DetailGameIgdbDto g, PaginationRequest reviewsPag)
    {
    ...
    public static IQueryable<DetailGameDto> GameToDetailDto
    (this IQueryable<Game> query, int reviewCount, int favoritesCount, PaginationRequest reviewsPag)
    {
        var page = reviewsPag.Page ?? CONSTANTS.DEF_PAGE;
        var pageSize = reviewsPag.PageSize ?? CONSTANTS.DEF_PAGESIZE;
